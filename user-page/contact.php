...
if (isset($_POST['bsimpan'])) {
    ...
    $query = mysqli_query($koneksi, "INSERT INTO contact (id_costumer, nama, email, pesan) VALUES ('$id', '$nama', '$email', '$pesan')");

    if ($query) {
        echo "<script>alert('Tambah data berhasil');document.location='contact.php';</script>";
    } else {
        echo "<script>alert('Tambah data gagal');document.location='contact.php';</script>";
    }
}
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="contact.php"><i class="fa-solid fa-id-card"></i> Contact</a>
                    </li>
                    <li class="nav-item">
...
<div class="container contact py-5 page-content">
<h1 class="judul-halaman text-center" data-aos="zoom-in" data-aos-duration="1000">Contact <span> Us</span></h1>
    <div class="jumbotron" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <form method="post">
                        <table>
                            <tr>
                                <td>
                                    <div class="input-box">
                                        <input type="text" class="input1" placeholder="Your name" name="nama">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="input-box">
                                        <input type="email"  class="input1" placeholder="Your email" name="email">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="input-box">
                                        <textarea class="massage" cols="30" rows="5" placeholder="massage" name="pesan"></textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <button type="submit" class="btn btn-light button-contact" name="bsimpan">Submit</button>
                                </td>
                            </tr>
                        </table>
                    </form>
        ...
        <div class="row">
            <div class="col">
                <div class="d-flex justify-content-around ataraxia-contact">
                    <a href="" class="link link-dark"><i class="fa-solid fa-globe"></i> ataraxia.com</a>
                    <a href="" class="link link-dark"><i class="fa-solid fa-phone"></i> +62 851-5684-5840</a>
                    <a href=""class="link link-dark"><i class="fa-solid fa-envelope"></i> ataraxia@gmail.com</a>
                </div>
            </div>
        </div>
    </div> 
