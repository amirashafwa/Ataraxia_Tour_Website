        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  active" aria-current="page" href="service.php"><i class="fa-solid fa-user-gear"></i> Service</a>
                    </li>
                    <li class="nav-item">
...
<div class="container py-5 page-content">
    <h1 class="judul-halaman text-center" data-aos="zoom-in" data-aos-duration="1000">Our <span> Services</span></h1>
    <div class="services-area">
        <div class="row row row-cols-1 row-cols-lg-4 row-cols-md-2 py-5">
            <div class="col">
                <div class="card services_content mx-3 pt-4" data-aos="fade-up" data-aos-duration="500">
                    <p class="icon_service"><i class="fa-solid fa-hotel"></i></p>
                    <h4 class="heading_services">Villa</h4>
                </div>
            </div>
            <div class="col">
                <div class="card services_content mx-3 pt-4"  data-aos="fade-up" data-aos-duration="1000">
                    <p class="icon_service"><i class="fa-solid fa-person-hiking"></i></p>
                    <h4 class="heading_services">Tour Guide</h4>
                </div>
            </div>
            <div class="col">
                <div class="card services_content mx-3 pt-4"  data-aos="fade-up" data-aos-duration="1500">
                    <p class="icon_service"><i class="fa-solid fa-truck-plane"></i></p>
                    <h4 class="heading_services">Transportation</h4>
                </div>
            </div>
            <div class="col">
                <div class="card services_content mx-3 pt-4" data-aos="fade-up" data-aos-duration="2000">
                    <p class="icon_service"><i class="fa-solid fa-file-invoice"></i></p>
                    <h4 class="heading_services">Doc Service</h4>
                </div>
            </div>
        </div>
    </div>
