        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="https://ataraxianews.000webhostapp.com/"><i class="fa-solid fa-newspaper"></i> News</a>
                    </li>
...
<section class="about page-content">
    ...
    <h1 class="judul-halaman text-center mb-5" data-aos="zoom-in" data-aos-duration="1000">About <span> Us</span></h1>
        <div class="row row-cols-1 row-cols-lg-2">
            <div class="col col-lg-5 video-container" data-aos="zoom-in"data-aos-duration="1000" >
                <video src="../gambar/InShot_20230802_200624545.mp4" loop autoplay muted></video>
                <h3>Find the Serenity You Desire</h3>
            </div>
            <div class="col col-lg-7 about-content" data-aos="zoom-in" data-aos-duration="1000">
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. ndus eligendi veniam recusandae architecto quod eius temporibus est, vitae natus facilis modi? Architecto, perferendis! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex illo velit dicta necessitatibus, repudiandae, facere fugit aspernatur ab nihil corporis asperiores fugiat, nulla sunt! Qui distinctio quisquam cupiditate cum saepe? Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum nesciunt reiciendis perferendis pariatur, officiis et eveniet?</p>
        </div>
    </div>
</section>
