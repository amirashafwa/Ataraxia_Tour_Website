...
<html lang="en">
  ...
  <body>
    ...
    <div class="container py-5 page-content">
      <h1 class="judul-halaman text-center" data-aos="zoom-in" data-aos-duration="1000">Our<span> Team</span></h1>
...
`         <div class="row">
              ...
              <div class="profile-card">
                ...
                <div class="caption">
                    ...
                    <div class="social-links">
                        ...
                        <a href="https://instagram.com/amirashafwa"><i class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
              </div>
            </div>
            <div class="col" data-aos="fade-up" data-aos-duration="1000">
              <div class="profile-card">
                <div class="img">
                    <img src="../gambar/man.png">
                </div>
                <div class="caption">
                    <h3>M. Fauzan</h3>
                    <p>Project Manager</p>
                    <div class="social-links">
                        <a href="https://www.facebook.com/Rexvexozia"><i class="fa-brands fa-facebook"></i></a>
                        <a href=""><i class="fa-brands fa-twitter"></i></a>
                        <a href="https://instagram.com/elzan.14"><i class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
              </div>
            </div>
              ...
              <div class="profile-card">
                ...
                <div class="caption">
                    ...
                    <div class="social-links">
                        <a href=""><i class="fa-brands fa-facebook"></i></a>
                        <a href=""><i class="fa-brands fa-twitter"></i></a>
                        <a href="https://instagram.com/syafnamn"><i class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
              </div>
            </div>
